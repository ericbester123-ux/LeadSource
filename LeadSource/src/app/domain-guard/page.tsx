...
const auditActions = [
  ...
  "SMTP config checked",
  "SMTP test email attempted",
  "SMTP test email sent",
  "SMTP test email failed",
  "SMTP test blocked by simulation mode",
  "SMTP missing config"
];
    ...
    <div className="space-y-6">
      <div className="flex flex-col justify-between gap-4 xl:flex-row xl:items-center">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Badge tone={emailProvider.smtpConfigured ? "green" : "gold"}>{emailProvider.smtpConfigured ? "SMTP CONFIGURED" : "SMTP MISSING"}</Badge>
