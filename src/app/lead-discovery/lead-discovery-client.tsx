...
export function LeadDiscoveryClient({ runs }: { runs: LeadDiscoveryRun[] }) {
                ...
                <tbody className="divide-y divide-black/10">
                  {localResults.map((lead) => (
                    <tr key={lead.previewId}>
                      ...
                      <td className="px-3 py-3"><a className="text-gold-700 underline" href={lead.website} target="_blank">{lead.website}</a></td>
                      ...
                      <td className="px-3 py-3">
                        {lead.duplicate ? <StatusBadge status="Duplicate" /> : lead.suppressed ? <StatusBadge status="Suppressed" /> : <StatusBadge status="Ready for Review" />}
                      </td>
                    </tr>
                  ))}
                </tbody>
